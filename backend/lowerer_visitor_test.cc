...
TEST_F(LowererTest, FunctionCallTest) {
  ...
  //    return retunval + 0
  // }
  statements.push_back(make_unique<const AssignmentFromArithExp>(make_unique<const VariableExpr>("bob"), make_unique<const IntegerExpr>(10)));
