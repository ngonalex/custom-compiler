#include "frontend/combinators/basic_combinators/num_parser.h"
#include "frontend/combinators/basic_combinators/single_digit.h"
...
ParseStatus NumParser::parse(std::string inputProgram) {
  ...
  OneOrMoreCombinator oneOrMore(digitParser);
	// Parse the integer
