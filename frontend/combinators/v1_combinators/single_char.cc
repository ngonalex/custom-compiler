...
ParseStatus SingleCharParser::do_parse(std::string inputProgram, int startCharacter) {
...
ParseStatus SingleVarCharParser::do_parse(std::string inputProgram, int startCharacter) {
